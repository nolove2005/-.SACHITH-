...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'SACHITH WA BOT SL',
    ...
    BOT_INFO: process.env.BOT_INFO || 'SL;SACHITH;972528277755;https://i.imgur.com/NGaJQta.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'SL;SACHITH;https://i.imgur.com/NGaJQta.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'SL;SACHITH' : process.env.STICKER_DATA,
